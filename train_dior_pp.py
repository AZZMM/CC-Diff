...
from ccdiff_pp.utils import get_similar_examplers
...
def main():
    ...
    image_proj_model = CoSampler(
        dim=1280,
        depth=4,
        dim_head=64,
        # heads=20,
        num_queries=8,
        embedding_dim=image_encoder.model.embed_dim,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                img_features, bg_features, rel_features = image_proj_model(img_features, obboxes, bg_features).split([ref_imgs.shape[0], 1, 1], dim=0)
    ...
    if accelerator.is_main_process:
        ...
        '''
        # torch.save(custom_layers.state_dict(), 'save.pth')
